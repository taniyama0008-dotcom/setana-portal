...
export const metadata: Metadata = {
  title: '自然 — せたなの暮らし・食・自然',
  description: '狩場山、日本海、断崖の霊場。せたな町の豊かな自然に触れてください。',
}

export default async function ShizenPage() {
  ...
  return (
    <>
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: '自然 — せたなの暮らし・食・自然',
            description: '狩場山、日本海、断崖の霊場。せたな町の豊かな自然。',
          }),
        }}
      />
      ...
      <section className="relative h-[40vh] min-h-[280px] flex items-center overflow-hidden">
        <div className="absolute inset-0 bg-gradient-to-br from-[#4a6b50] to-[#6b8f71]" />
