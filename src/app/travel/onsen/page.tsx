      ...
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'WebPage',
            name: 'せたな町の温泉',
            url: 'https://setana-portal.vercel.app/travel/onsen',
            breadcrumb: {
              '@type': 'BreadcrumbList',
              itemListElement: [
                ...
                { '@type': 'ListItem', position: 3, name: '温泉', item: 'https://setana-portal.vercel.app/travel/onsen' },
              ],
            },
          }),
        }}
      ...
      <section className="py-16 lg:py-24 px-5 lg:px-8 bg-white">
        <div className="max-w-[1120px] mx-auto">
          {list.length === 0 ? (
            ...
            <>
              <p className="text-[#8a8a8a] text-[13px] mb-8">{list.length}件の温泉スポット</p>
