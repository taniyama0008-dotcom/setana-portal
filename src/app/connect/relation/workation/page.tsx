...
const jsonLd = {
  ...
  '@type': 'WebPage',
  name: '二拠点・ワーケーション — せたな町',
  url: 'https://www.setana.life/connect/relation/workation',
  breadcrumb: {
    '@type': 'BreadcrumbList',
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 4, name: '二拠点・ワーケーション', item: 'https://www.setana.life/connect/relation/workation' },
    ],
  },
}
      ...
      <section className="relative h-[40vh] min-h-[280px] flex items-end overflow-hidden">
        ...
        <div className="relative z-10 w-full max-w-[1120px] mx-auto px-5 lg:px-8 pb-12">
          <nav className="flex items-center gap-2 text-white/40 text-[12px] mb-4 flex-wrap">
            ...
            <span>›</span>
            <span className="text-white/70">二拠点・ワーケーション</span>
          </nav>
          <p className="text-white/40 text-[11px] font-medium tracking-[0.25em] mb-2 nav-label">WORKATION</p>
          <h1 className="text-white font-light text-[28px] lg:text-[40px] leading-[1.3]" style={{ fontWeight: 300 }}>
            二拠点・<span className="font-bold">ワーケーション</span>
          </h1>
        </div>
      </section>
      ...
      <section className="py-16 lg:py-24 px-5 lg:px-8 bg-white">
        <div className="max-w-[680px] mx-auto">
          <p className="text-[15px] text-[#5c5c5c] leading-[1.9] tracking-[0.06em] mb-12">
            このページは現在準備中です。せたな町でのワーケーション情報をまもなくお届けします。
          </p>
