...
export default async function FurusatoPage() {
  const setting = await getCategorySetting('connect/furusato')
      ...
      <section className="relative h-[50vh] min-h-[360px] flex items-end overflow-hidden">
        {setting?.hero_image_url ? (
          ...
          <div
            ...
            style={{ background: buildGradient(setting, '#0f1e1b', '#1a3028', '#1a2820') }}
          />
        )}
        ...
        <div className="relative z-10 w-full max-w-[1120px] mx-auto px-5 lg:px-8 pb-14">
          ...
          <p className="text-white/60 text-[15px] leading-[1.8] mt-3 max-w-[480px]">
            {setting?.description ?? '返礼品と寄付金の使いみち、生産者の顔が見える。せたなを応援する寄付。'}
          </p>
        </div>
      </section>
